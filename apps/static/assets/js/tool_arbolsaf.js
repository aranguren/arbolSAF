...
var MODES = {
    ...
    biodiversidad: {
        cols: [
            ...
            { title: 'Micro-<br>mamíferos',  data: 'v90_micromamiferos', render: boolDot },
            ...
            { title: 'Valor<br>biodiv.',     data: 'VALOR BIODIVERSIDAD' },
            { title: 'Seleccione',           data: 'CODIGO',             render: renderCheckbox, orderable: false },
        ]
    },
    otrosusos: {
...
var CS_MODES = {
    ...
    suelo: {
        cols: [
            ...
            { title: 'Suelos<br>bien drenados',      data: 'v153_desarrollo_suelos_drenados', render: renderSINO },
            { title: 'Suelos<br>rocosos',            data: 'v152_desarrollo_suelos_rocosos',  render: renderSINO },
            { title: 'Tolerancia<br>acidez',         data: 'v108_tolerancia_acidez',          render: renderSINO },
            { title: 'Tolerancia<br>salinidad',      data: 'v109_tolerancia_salinidad',       render: renderSINO },
...
var MORFO_MODES = {
    forma: {
        cols: [
            { title: 'Especie',                  data: 'NOMBRE COMUN' },
            { title: 'Altura<br>potencial (m)',   data: 'v1_altura_copa' },
            { title: 'Ancho<br>copa (m)',         data: 'v2_ancho_potencial_copa' },
            { title: 'Tipo<br>ramificación',      data: 'v13_tipo_ramificacion_copa' },
            { title: 'Forma<br>de copa',          data: 'v7_forma_copa' },
            { title: 'Forma<br>de fuste',         data: 'v144_forma_fuste' },
            { title: 'Follaje',                   data: 'v6_follage' },
            { title: 'Frec.<br>de poda',          data: 'v9_frecuencia_poda' },
    ...
    ecologia: {
        cols: [
            ...
            { title: 'Fenología<br>de hojas',            data: 'v37_fenologia_hojas' },
            { title: 'Época<br>caída hojas',             data: 'v35_epoca_caida_hojas', render: renderMonths },
            { title: 'Tipo<br>ramificación',             data: 'v13_tipo_ramificacion_copa' },
            { title: 'Frec.<br>de poda',                 data: 'v9_frecuencia_poda' },
