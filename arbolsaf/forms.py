...
class SpeciesForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'familia': forms.Select(attrs={'class': 'js-select2-simple form-select form-select-lg'}),
            'genero': forms.Select(attrs={'class': 'js-select2-simple form-select form-select-lg'}),
...
class VariableO2MForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'tipo_variable': forms.Select(attrs={'class': 'js-select2-simple form-select form-select-lg'}),
            'referencia': forms.Select(attrs={'class': 'js-select2-simple form-select form-select-lg'}),
            'referencia_2': forms.Select(attrs={'class': 'js-select2-simple form-select form-select-lg'}),
...
class VariableSpeciesForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            #'referencia': forms.Select(attrs={'class': 'form-select form-select-lg'}),
            'tipo_variable': forms.Select(attrs={'class': 'js-select2-simple form-select form-select-lg'}),
            'especie': forms.Select(attrs={'class': 'js-select2-simple form-select form-select-lg'}),
            'referencia': forms.Select(attrs={'class': 'js-select2-simple form-select form-select-lg'}),
            'referencia_2': forms.Select(attrs={'class': 'js-select2-simple form-select form-select-lg'}),
            'valor_numerico':forms.NumberInput(attrs={'class': 'form-control'}),
            'valor_texto':forms.TextInput(attrs={'class': 'form-control'}),
