# Generated by Django 3.2.6 on 2022-11-16 19:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre_comun', models.CharField(max_length=255, verbose_name='Taxon ID WFO')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL, verbose_name='Modificado por')),
                ('variable', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='arbolsaf.variablemodel', verbose_name='Variable')),
            ],
            options={
